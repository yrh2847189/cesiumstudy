...
//   );
  ...
  const entity = viewer.entities.add({
    name: "https://zouyaoji.top/vue-cesium/SampleData/models/GroundVehicle/GroundVehicle.glb",
    position: position,
  ...
  // viewer.scene.fxaa = false; // 关闭fxaa  最新的cesium已经将fxaa移到PostProcessStageCollection
});
</script>
<style scoped>
#cesiumContainer {
